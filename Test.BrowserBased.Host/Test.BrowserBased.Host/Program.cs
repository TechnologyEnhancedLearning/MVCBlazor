using Test.BrowserBased.Host.Client.Pages;
using Test.BrowserBased.Host.Components;
//namespace Test.BrowserBased.Host;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(Test.BrowserBased.Host.Client._Imports).Assembly);
