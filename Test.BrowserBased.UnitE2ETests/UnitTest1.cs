...
namespace Test.BrowserBased.UnitE2ETests
{

    //public class UnitTest1 : BlazorPageTest<Test.BrowserBased.Host.Program>
    public class UnitTest1 : BlazorPageTest<Program>
...

    {
        ...
        [Fact]
        public async Task Count_Increments_WhenButtonIsClicked_differentSetUp()
        {
            // Arrange
            ...
            using Microsoft.Playwright.IPlaywright playwright = await Microsoft.Playwright.Playwright.CreateAsync();
