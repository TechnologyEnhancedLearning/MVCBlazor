...
{
    public class SharedIpageFasterLessIssolated_BrowserBasedTests_FAILED : BlazorPageTest<Program>
    {
        ...
        //    ILocator button = BrowserContextPageDictionary[browserConfig].GetByRole(AriaRole.Button, new() { Name = "Click me" }); // Change the name if needed
