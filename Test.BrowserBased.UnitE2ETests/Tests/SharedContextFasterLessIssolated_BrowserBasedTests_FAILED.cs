...
{
    public class SharedContextFasterLessIssolated_BrowserBasedTests_FAILED : BlazorPageTest<Program>
    {
        //[Theory]
        ...
        //public async Task Page_InteractivityIsCorrectlySimulated2(BrowserConfig browserConfig, bool jsEnabled = true)
        //{
